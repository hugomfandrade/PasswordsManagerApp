package org.hugoandrade.passwordsmanagerapp.customview;
...
public class KeyboardView extends LinearLayout {
    ...
    public final static int KEY_ZERO = 0;
    ...
    public final static int KEY_FIVE = 5;
    public final static int KEY_SIX = 6;
    public final static int KEY_SEVEN = 7;
    public final static int KEY_EIGHT = 8;
    public final static int KEY_NINE = 9;
    public final static int KEY_DELETE = 11;
    public final static int KEY_BOTTOM_LEFT = 12;
    ...
    public void setOnKeyboardKeyListener(OnKeyListener onKeyboardKeyListener) {
        mOnKeyListener = onKeyboardKeyListener;
        rvKeyboard.getAdapter().notifyDataSetChanged();
    }

    public interface OnKeyListener {
        void onKeyClicked(int keyboardKey);
    }
            ...
            holder.vKey.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (holder.getAdapterPosition() == 9)
                        mOnKeyListener.onKeyClicked(KEY_BOTTOM_LEFT);
                    else if (holder.getAdapterPosition() == 10)
                        mOnKeyListener.onKeyClicked(KEY_ZERO);
                    else if (holder.getAdapterPosition() == 11)
                        mOnKeyListener.onKeyClicked(KEY_DELETE);
                    else
                        mOnKeyListener.onKeyClicked(holder.getAdapterPosition() + 1);
                }
            });
            holder.vKey.setClickable(mOnKeyListener != null);
        }
