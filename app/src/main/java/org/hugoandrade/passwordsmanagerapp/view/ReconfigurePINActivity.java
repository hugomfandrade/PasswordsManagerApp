...
public class ReconfigurePINActivity extends AppCompatActivity {
    ...
    private KeyboardView.OnKeyListener mOnKeyboardKeyClicked
            = new KeyboardView.OnKeyListener() {
        @Override
    ...
    public void reportMessage(String message) {
        OptionUtils.showSnackBar(findViewById(R.id.layout_activity_reconfigure), message);
    }
}
